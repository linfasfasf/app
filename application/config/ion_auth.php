...
*/
$config['tables']['users']           = 'cp_users';
$config['tables']['groups']          = 'cp_groups';
$config['tables']['users_groups']    = 'cp_users_groups';
$config['tables']['login_attempts']  = 'cp_login_attempts';
...
$config['min_username_length']        = 5;
$config['max_username_length']        = 40;

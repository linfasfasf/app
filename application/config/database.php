...
$db['product']['hostname'] = 'writedb.ccp.punchbox.usr';
$db['product']['username'] = 'joy';
$db['product']['password'] = 'aSF3jk78';
$db['product']['database'] = 'cocosplay_system';
...
$db['sandbox']['hostname'] = '10.10.2.28';
$db['sandbox']['username'] = 'joy';
$db['sandbox']['password'] = 'aSF3jk78';
$db['sandbox']['database'] = 'cocosplay_system';

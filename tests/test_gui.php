...
<body>
	...
	<div id="nav">
		...
		<?php echo form_close(); ?>
		<?php echo form_open($form_url); ?>
			<input type="hidden" name="controllers2" value="1" />
			<input type="submit" value="Controllers2" />
		<?php echo form_close(); ?>
		<?php echo form_open($form_url); ?>
			<input type="hidden" name="apiv3" value="1" />
			<input type="submit" value="Apiv3" />
		<?php echo form_close(); ?>
		<?php echo form_open($form_url); ?>
			<input type="hidden" name="apiv4" value="1" />
			<input type="submit" value="Apiv4" />
		<?php echo form_close(); ?>
		<?php echo form_open($form_url); ?>
		...
		<?php echo form_close(); ?>
                <?php echo form_open($form_url); ?>
			<input type="hidden" name="phpscript" value="1" />
			<input type="submit" value="phpscript" />
		<?php echo form_close(); ?>
		...
		<?php echo form_open($form_url); ?>
			<select name="test">
				...
				<optgroup label="Controllers2">
					<?php foreach ($controllers2 as $value) { ?>
						<option value="controllers2/<?php echo $value ?>" <?php if ($value == $testName) { echo 'selected="selected"'; } ?>><?php echo $value; ?></option>
					<?php } ?>
				</optgroup>
				<optgroup label="apiv3">
					<?php foreach ($apiv3 as $value) { ?>
						<option value="apiv3/<?php echo $value ?>" <?php if ($value == $testName) { echo 'selected="selected"'; } ?>><?php echo $value; ?></option>
					<?php } ?>
				</optgroup>
				<optgroup label="apiv4">
					<?php foreach ($apiv4 as $value) { ?>
						<option value="apiv4/<?php echo $value ?>" <?php if ($value == $testName) { echo 'selected="selected"'; } ?>><?php echo $value; ?></option>
					<?php } ?>
				</optgroup>
				...
				<optgroup label="Bugs">
					...
					<?php } ?>
                                ...
                                <optgroup label="phpscript">
					<?php foreach ($phpscript as $value) { ?>
						<option value="phpscript/<?php echo $value ?>" <?php if ($value == $testName) { echo 'selected="selected"'; } ?>><?php echo $value; ?></option>
					<?php } ?>
				</optgroup>                                
			</select>

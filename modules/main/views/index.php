		...
		<div class="span12">
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
                    ...
                    <p class="link">link</p>
			<div class="carousel slide" id="carousel-72675">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-72675">
					</li>
					<li data-slide-to="1" data-target="#carousel-72675">
					</li>
			k		<li data-slide-to="2" data-target="#carousel-72675">
					</li>
				</ol>
				...
				</div> <a data-slide="prev" href="#carousel-72675" class="left carousel-control">‹</a> <a data-slide="next" href="#carousel-72675" class="right carousel-control">›</a>
			</div>
		</div>
	</div>
	<div class="row-fluid">
